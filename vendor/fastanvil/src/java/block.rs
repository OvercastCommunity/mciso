...
impl Block {
    // mciso patch: propless constructor so set_custom_block_callback impls can
    // build stand-in blocks without a vendor fork of JavaChunk::block
    pub fn new(name: String) -> Self {
        let encoded = name.clone() + "|";
        Self {
            name,
            encoded,
